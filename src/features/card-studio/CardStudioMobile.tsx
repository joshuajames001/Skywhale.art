...
import {
    ...
    Download, Share2, FilePlus, BookOpen, Search, Star, Languages, Copy,
} from 'lucide-react';
...
type Panel = 'templates' | 'background' | 'stickers' | 'text' | 'ai' | 'dictionary' | null;
        ...
        <>
            ...
            <nav className="shrink-0 bg-white border-t border-gray-100 flex overflow-x-auto z-50">
                {([
                    ...
                    { id: 'dictionary' as Panel, icon: BookOpen, label: 'Slovník' },
                    ...
                    >
                        ...
                        <div className="shrink-0 flex items-center gap-3 px-4 py-3 border-b border-gray-100">
                            ...
                            <span className="text-base font-bold text-gray-800">
                                ...
                                {activePanel === 'dictionary' && 'Slovník'}
                        ...
                        <div className="flex-1 overflow-y-auto p-4">
                            ...
                            {activePanel === 'stickers' && (
                                <StickersPanel
                                    ...
                                    onOpenAI={() => { setAiMode('sticker'); setActivePanel('ai'); }}
                                />
                            )}
                            {activePanel === 'text' && (
...
/* ───────────────────────────────────────────────
   DICTIONARY PANEL
   ─────────────────────────────────────────────── */
const CardDictionaryPanel: React.FC = () => {
